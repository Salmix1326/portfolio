(() => {
    ...
    let btnLang = document.querySelector(".menu__change-lang");
    document.addEventListener("click", (function(e) {
        if (e.target.closest(".menu__change-lang")) btnLang.classList.add("_active"); else btnLang.classList.remove("_active");
    }));
    window["FLS"] = true;
    isWebp();
    addTouchClass();
